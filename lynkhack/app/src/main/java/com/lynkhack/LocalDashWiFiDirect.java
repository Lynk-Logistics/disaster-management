...
//        connListener.start();
        ...
        checkWritePermission();
         datafromother = getIntent().getStringExtra("FROM_LYNK");
                ...
                case DataHandler.CHAT_RESPONSE_RECEIVED:
                    ...
                    if (!isChatRequestAccepted) {
                        ...
                        DeviceDTO chatDevice = (DeviceDTO) intent.getSerializableExtra(DataHandler
                                .KEY_CHAT_REQUEST);
                        DialogUtils.openChatActivity(LocalDashWiFiDirect.this, chatDevice,datafromother);
...
//            appController.startConnectionListener(ConnectionUtils.getPort(LocalDashWiFiDirect.this));
    ...
    @Override
    public void onListFragmentInteraction(final DeviceDTO deviceDTO) {
        if (!isWDConnected) {
