...
import static com.dwarsoftgames.dwarsoft_lynk_hackathon.Utils.Constants.ORGANIZATION_AUTH;
import static com.dwarsoftgames.dwarsoft_lynk_hackathon.Utils.Constants.SHAREDPREF;

public class OrganizationAuth extends AppCompatActivity {
    ...
    private void post_Phone() {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,
                ORGANIZATION_AUTH, new JSONObject(params),
        ...
        try {
            if (jsonObject.getBoolean("isSuccess")) {
                ...
                if (jsonObject.getBoolean("isNewUser")) {
                    ...
                    db.userDao().updateOrgID(jsonObject1.getInt("OrgID"));
    ...
    private void openAuthDetails() {
        Intent intent = new Intent(OrganizationAuth.this, OrganizationAuthDetails.class);
